...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $installer->getConnection()->newTable(
            $installer->getTable('duy_banners_slider_group')
        )->addColumn(
            'id',
         ...
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable('duy_banners_slider')
        )->addColumn(
            'id',
            ...
            $installer->getFkName('duy_banners_slider', 'store_id', 'store', 'store_id'),
            'store_id',
            $installer->getTable('store'),
            'store_id',
            \Magento\Framework\DB\Ddl\Table::ACTION_NO_ACTION
        )->addForeignKey(
            $installer->getFkName('duy_banners_slider', 'group_id', 'duy_banners_slider_group', 'id'),
            'group_id',
            $installer->getTable('duy_banners_slider_group'),
            'id',
            \Magento\Framework\DB\Ddl\Table::ACTION_NO_ACTION
