...
namespace Duy\BannerSlider\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Duy\BannerSlider\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Duy_BannerSlider::page/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \Duy\BannerSlider\Block\Adminhtml\Page\Menu $menu */
